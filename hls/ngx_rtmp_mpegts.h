...
ngx_int_t ngx_rtmp_mpegts_open_file(ngx_rtmp_mpegts_file_t *file, u_char *path,
    ngx_log_t *log);
ngx_int_t ngx_rtmp_mpegts_close_file(ngx_rtmp_mpegts_file_t *file, u_char *path, u_char *host, u_char *bucket, u_char *key, u_char *access_key, u_char *secret_key, u_char *acl);
